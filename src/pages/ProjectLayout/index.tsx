        ...
        <Card className="app-surface border-0" styles={{ body: { padding: 20 } }}>
          <Space direction="vertical" size={16} className="w-full">
            <div className="rounded-[var(--app-radius-md)] border border-[color:var(--app-border-subtle)] bg-[color:var(--app-bg-muted)] p-4">
              ...
              <div className="mt-2 text-base font-medium text-[color:var(--app-text-primary)]">{projectId}</div>
            </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="mt-1 text-sm text-[color:var(--app-text-tertiary)]">{tab.description}</div>
                      </div>
                    </div>
                  </NavLink>
                );
