...
import { Button, Divider, Empty, Form, Input, Modal, Radio, Tag, Typography, Upload, message } from "antd";
...
function HomePage() {
  ...
  return (
    <main className="page-screen flex min-h-screen p-2">
